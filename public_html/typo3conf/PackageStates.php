...
return [
    'packages' => [
        ...
        'backendtools' => [
            'packagePath' => 'typo3conf/ext/backendtools/',
        ],
        'core_upgrader' => [
            'packagePath' => 'typo3conf/ext/core_upgrader/',
        ],
        'extension_builder' => [
        ...
        'pimentconfig' => [
            'packagePath' => 'typo3conf/ext/pimentconfig/',
        ],
        'sourceopt' => [
            'packagePath' => 'typo3conf/ext/sourceopt/',
        ],
        'trainingcaces' => [
            'packagePath' => 'typo3conf/ext/trainingcaces/',
        ],
        'translate_locallang' => [
